...
def setup_dspy():
    """Initialize DSPy with Hugging Face Llama 3.2-3B Instruct"""
    try:
        import os
        from langchain_huggingface import HuggingFaceEndpoint
        
        # Properly inherit from BaseLM with all required methods
        class HuggingFaceLM(dspy.BaseLM):
            def __init__(self):
                super().__init__(model="meta-llama/Llama-3.2-3B-Instruct")
        ...
        print(" DSPy configured with Llama-3.2-3B-Instruct")
        return True
